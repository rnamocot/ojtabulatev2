...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 18, 2023 at 09:50 AM
...
(17, 'Appointment Set', 'School District 1', 'John Doe', '44324', 'tssst2@gmail.com', 'USA', '2023-04-08 12:24:40', 19),
...
--
-- Table structure for table `ojt_employee_notes`
--

CREATE TABLE `ojt_employee_notes` (
  `ojt_employee_note_id` int(255) NOT NULL,
  `ojt_employee_note_contents` varchar(10000) NOT NULL,
  `ojt_employee_note_created` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `ojt_employee_id` int(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Indexes for table `ojt_employee_notes`
--
ALTER TABLE `ojt_employee_notes`
  ADD PRIMARY KEY (`ojt_employee_note_id`),
  ADD KEY `ojt_employee_id` (`ojt_employee_id`);
...
--
-- AUTO_INCREMENT for table `ojt_employee_notes`
--
ALTER TABLE `ojt_employee_notes`
  MODIFY `ojt_employee_note_id` int(255) NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `ojt_employee_notes`
--
ALTER TABLE `ojt_employee_notes`
  ADD CONSTRAINT `ojt_employee_notes_ibfk_1` FOREIGN KEY (`ojt_employee_id`) REFERENCES `ojt_employee` (`ojt_employee_id`);
COMMIT;
